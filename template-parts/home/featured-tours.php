                ...
                <?php while ($query->have_posts()):
                    ...
                    <a href="<?= the_permalink(); ?>" class="tour-item" aria-label="<?= the_title(); ?>">
                        <div class="tour-item__thumb">
                            ...
                            <div
                                class="tour-item__category d-flex align-items-center align-content-center justify-content-center gap-2">
                                ...
                                <div class="tour-item-info d-flex align-content-center justify-content-between">
                                    <?php if (!empty($time_tour)): ?>
                                        <div class="tour-item-info__time d-flex align-items-center ">
                                            <svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M17 13H12V8" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 3.5L7 2" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M19 3.5L17 2" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 22C16.9706 22 21 17.9706 21 13C21 8.02944 16.9706 4 12 4C7.02944 4 3 8.02944 3 13C3 17.9706 7.02944 22 12 22Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                            <?= $time_tour ?>
                                        </div>
                                    <?php endif; ?>

                                    <?php if (!empty($paxs_tours)): ?>
